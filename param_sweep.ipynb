 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    objPos = pd.read_csv(\"demo_data/demo_seating_chart.csv\", index_col=False) \n",
    "    obsLog = pd.read_csv(\"demo_data/demo_obs_log.csv\", index_col=False) \n",
    "\n",
    "    # dataframe to hold the result of the sweep\n",
    ...
    "                                           teacherPos.timestamp, teacherPos.period, \n",
    "                                           teacherPos.day, duration, radius) \n",
    ...
    "                    # match/guess percentage metrics are deprecated \n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# RUN CODE FROM HERE: Explore search space"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "  0%|          | 0/4 [00:00<?, ?it/s]/var/folders/29/l7nrj2kj79s5n10vdwh2ywnc0000gn/T/ipykernel_45169/585524716.py:186: UserWarning: Boolean Series key will be reindexed to match DataFrame index.\n",
      "  posInTimeframe = posDF[timeframeStart < posDF[\"timestamp\"]][posDF[\"timestamp\"] < timeframeEnd]\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 200 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 200 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 200 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 800 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 800 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 800 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 14\n",
      "###########################################\n"
     ]
    },
    {
    ...
    },
    {
     ...
     "text": [
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 1400 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 1400 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 4\n",
      "n_false_alarms_outside is 11\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 3 1400 1300\n",
      "n_hits is 8\n",
      "n_misses is 1\n",
      "n_false_alarms_inside is 8\n",
      "n_false_alarms_outside is 79\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 200 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 200 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 200 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
    ...
    },
    {
     ...
     "text": [
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 800 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 800 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 800 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 1400 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 1400 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 12 1400 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 200 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 200 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 200 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 800 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 800 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 800 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 1400 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 1400 700\n",
      "n_hits is 5\n",
      "n_misses is 4\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 5\n",
    ...
    },
    {
     ...
     "text": [
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 21 1400 1300\n",
      "n_hits is 7\n",
      "n_misses is 2\n",
      "n_false_alarms_inside is 1\n",
      "n_false_alarms_outside is 12\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 200 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 200 700\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 200 1300\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
    ...
    },
    {
     ...
     "text": [
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 800 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 800 700\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 800 1300\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 1400 100\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 1400 700\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Hyperparameter timeframe is: 10\n",
      "Parameter set (duration, radius, range) is: 30 1400 1300\n",
      "n_hits is 0\n",
      "n_misses is 9\n",
      "n_false_alarms_inside is 0\n",
      "n_false_alarms_outside is 0\n",
      "###########################################\n",
      "Changes to the data file has been saved to demo_data/demo_param_sweep_results_medium_resolution.csv\n",
      "###########################################\n"
     ]
    },
    {
   ...
   "source": [
    ...
    "    df_ref = run_param_sweep(verbose=True, outputFileName=\"demo_data/demo_param_sweep_results_medium_resolution.csv\", \n",
    "                             resolution=\"medium\")"
   ]
  }
 ],
